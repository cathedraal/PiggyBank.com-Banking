    ...
    renderPopup(
      ...
      (confirmed) => {
        if (confirmed) {
          ...
          changeCurrency(
            currencies[getRandomInt(0, currencies.length - 1)].value
          );
          changeCardType(
            cardTypes[getRandomInt(0, cardTypes.length - 1)].value
          );
